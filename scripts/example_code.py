"""
Example code for estimating hip joint angles from wearable magnetic and inertial sensors.
...
def import_sample_data(path_to_sample_data):
    ...
    # static calibration: useful to have the shank data to compute a scaling factor to make the gravity vectors similar
